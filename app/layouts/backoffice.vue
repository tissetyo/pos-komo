...
const navItems = [
  ...
  { label: 'Tables', icon: 'i-lucide-armchair', to: '/backoffice/tables' },
  { label: 'Payments', icon: 'i-lucide-credit-card', to: '/backoffice/payments' },
  ...
  <div class="h-screen w-screen bg-gray-50 flex font-sans overflow-hidden">
    ...
    <aside class="w-56 bg-[#162456] flex flex-col flex-shrink-0 z-10">
      ...
      <div class="p-4 border-t border-white/10 flex flex-col gap-1">
        <NuxtLink to="/kitchen" class="flex items-center gap-2 px-3 py-2 rounded-lg text-sm font-medium text-amber-400 hover:bg-white/5 transition-colors">
          <UIcon name="i-lucide-chef-hat" class="w-5 h-5" />
          Kitchen Portal
        </NuxtLink>
