...
<template>
  <div class="max-w-md w-full p-8 bg-white rounded-3xl shadow-xl flex flex-col gap-6 transform transition-all">
    <div class="text-center">
      ...
      <h1 class="text-3xl font-bold text-gray-900 mb-2">Komo POS</h1>
      <p class="text-gray-500 text-sm">Sign in with your admin or cashier PIN</p>
    </div>
